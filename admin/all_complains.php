...
function subject($id) {
    ...
    $query = $conn->query("select * from complain order by id desc") or die("Failed to load...try Again!.");
...
<tr>
    ...
    <td>            
        <a href="view_complain.php?com_id=<?php echo $rows['id'] ?>" class="btn btn-info btn-sm">
